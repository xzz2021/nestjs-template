...
//     ApiExtraModels(options.paginationType === 'offset' ? OffsetPaginatedDto : CursorPaginatedDto, options.type),
//     ApiOkResponse({
...
//         allOf: [
//           {
//             $ref: getSchemaPath(options.paginationType === 'offset' ? OffsetPaginatedDto : CursorPaginatedDto),
//           },
//           {
//             properties: {
//               data: {
